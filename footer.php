<footer aria-label="Site Footer" class="bg-blue-900">
  <div class="max-w-screen-xl px-4 py-16 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      ...
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
        <div>
          ...
          <nav aria-label="Footer Navigation - Quick Links" class="mt-6">
        ...
        <div>
          <p class="font-medium text-white">Categories</p>

          <nav aria-label="Footer Navigation - Categories" class="mt-6">
            <ul class="space-y-4 text-sm">
              <li>
                <a href="#" class="text-white transition hover:opacity-75">
                  Mobiles
    ...
    <p class="text-xs text-white" style="margin-top:1.5rem;">
      &copy; <?php echo date("Y"); ?> Gadgets90.com.pk All Rights Reserved.
    </p>
  </div>
</footer>
<script>
